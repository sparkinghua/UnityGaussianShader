...
namespace GaussianSplatting.Editor
{
    ...
    public class GaussianSplatRendererEditor : UnityEditor.Editor
    {
        ...
        SerializedProperty m_EnvironmentMap;
        ...
        public void OnEnable()
        {
            ...
            m_EnvironmentMap = serializedObject.FindProperty("m_EnvironmentMap");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_EnvironmentMap);
